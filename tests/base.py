...
class BaseTestCase(TestCase):
    ...
    def create_redflag(self):
        ...
        """
        token = self.get_user_token()
        results = self.client.post('/redflags', data=json.dumps("title":"Judicial Corruption","category":"redflag","comment":"Bribery","location":"[0.9090,2.4356]"}), headers={"auth_token": token}, content_type = 'application/json')
        return results
